"""Celery email worker — processes bulk email queue.

Runs as a separate Railway service. Picks up email jobs from the Redis queue,
personalises templates, calls Resend, and updates recipient status in Supabase.
...
from lib.resend_client import send_email
