...
from routers import scrape, ai, email, tracker, templates, campaigns, job_search, startup_hunt, startup_scout, profile
...
app.include_router(startup_scout.router, prefix="/api/startup-scout", tags=["startup-scout"])
